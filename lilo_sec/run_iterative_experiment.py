...
parser.add_argument(
    "--max_mem_per_enumeration_thread",
    default=None,
    type=int,
    help="Maximum virtual address space, in bytes, for each solver child. Defaults to the model wrapper/template value.",
)
...
def main(args):
    ...
    for random_seed in args.random_seeds:
        config_base = build_config(
            ...
            max_mem_per_enumeration_thread=args.max_mem_per_enumeration_thread,
