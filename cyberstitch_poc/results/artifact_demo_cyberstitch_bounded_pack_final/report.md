...
- `java_barrier_kind_command_injection_sanitizer_55e58169` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`CommandInjectionSanitizer`
- `java_barrier_kind_exec_tainted_environment_sanitizer_8dc28406` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`ExecTaintedEnvironmentSanitizer`
...
- `java_barrier_kind_simple_type_sanitizer_e9ce4fe8` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`SimpleTypeSanitizer`
- `java_barrier_kind_barrier_node_command_injection_b7def791` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:command-injection`
- `java_barrier_kind_barrier_node_sql_injection_e9753cda` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:sql-injection`
- `java_method_call_sink_com_mongodb_basic_dbobject_parse_3b89d47e` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`com.mongodb.BasicDBObject.parse`
- `java_method_call_sink_java_lang_runtime_exec_52113dc7` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`java.lang.Runtime.exec`
- `java_method_call_sink_method_names_execute_c9d840b7` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute`
- `java_method_call_sink_method_names_execute_query_514e6e45` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeQuery`
- `java_method_call_sink_method_names_execute_update_fea6da3c` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeUpdate`
- `java_method_call_sink_method_names_execute_execute_query_execute_update_9f51233b` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute|executeQuery|executeUpdate`
- `java_modeled_sink_type_command_injection_sink_6ff11185` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`CommandInjectionSink`
...
- `java_modeled_sink_type_query_injection_sink_d3b4d4e5` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`QueryInjectionSink`
...
- `java_sink_kind_sink_node_command_injection_661bf632` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:command-injection`
- `java_sink_kind_sink_node_environment_injection_4e656c38` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:environment-injection`
- `java_sink_kind_sink_node_sql_injection_13d16ba6` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:sql-injection`
- `java_source_kind_remote_flow_source_d012efcf` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource`
- `java_source_kind_remote_flow_source_04675e95` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource`
- `java_source_kind_source_node_database_bfe0453b` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:database`
- `java_source_kind_source_node_remote_da62e92f` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:remote`
- `java_threat_model_active_threat_model_source_8e4eb24d` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource`
- `java_threat_model_active_threat_model_source_bd3900aa` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource`
...
- `java_barrier_kind_command_injection_sanitizer_55e58169`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
- `java_barrier_kind_exec_tainted_environment_sanitizer_8dc28406`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
...
- `java_barrier_kind_simple_type_sanitizer_e9ce4fe8`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
- `java_barrier_kind_barrier_node_command_injection_b7def791`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
- `java_barrier_kind_barrier_node_sql_injection_e9753cda`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
...
- `java_flow_config_template_data_flow_config_sig_9d3ff9d4`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_flow_config_template_data_flow_config_sig_7fd38ba7`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_method_call_sink_com_mongodb_basic_dbobject_parse_3b89d47e`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_java_lang_runtime_exec_52113dc7`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_c9d840b7`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_query_514e6e45`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_update_fea6da3c`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_execute_query_execute_update_9f51233b`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_modeled_sink_type_command_injection_sink_6ff11185`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_modeled_sink_type_query_injection_sink_d3b4d4e5`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_sink_kind_sink_node_command_injection_661bf632`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_sink_kind_sink_node_environment_injection_4e656c38`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_sink_kind_sink_node_sql_injection_13d16ba6`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_remote_flow_source_d012efcf`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_source_kind_remote_flow_source_04675e95`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_source_node_database_bfe0453b`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_source_node_environment_7ab858b5`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_source_node_remote_9df476b1`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_source_kind_source_node_remote_da62e92f`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_threat_model_active_threat_model_source_8e4eb24d`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_threat_model_active_threat_model_source_bd3900aa`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_flow_config_template_data_flow_config_sig_9d3ff9d4`: `['structural syntax-compression template']`
- `java_flow_config_template_data_flow_config_sig_7fd38ba7`: `['structural syntax-compression template']`
...
- `java_source_kind_source_node_environment_7ab858b5`: `['outside bounded LILO inventory cap']`
...
- `java_source_kind_source_node_remote_9df476b1`: `['outside bounded LILO inventory cap']`
...
- `java_barrier_kind_command_injection_sanitizer_55e58169` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`CommandInjectionSanitizer` rewrite=`False` usefulness=`semantic`
- `java_barrier_kind_exec_tainted_environment_sanitizer_8dc28406` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`ExecTaintedEnvironmentSanitizer` rewrite=`False` usefulness=`semantic`
...
- `java_barrier_kind_simple_type_sanitizer_e9ce4fe8` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`SimpleTypeSanitizer` rewrite=`False` usefulness=`semantic`
- `java_barrier_kind_barrier_node_command_injection_b7def791` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:command-injection` rewrite=`False` usefulness=`semantic`
- `java_barrier_kind_barrier_node_sql_injection_e9753cda` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:sql-injection` rewrite=`False` usefulness=`semantic`
...
- `java_flow_config_template_data_flow_config_sig_9d3ff9d4` `java_flow_config_template_v1` role=`FlowConfigTemplate` target=`DataFlow::ConfigSig` rewrite=`False` usefulness=`semantic`
- `java_flow_config_template_data_flow_config_sig_7fd38ba7` `java_flow_config_template_v1` role=`FlowConfigTemplate` target=`DataFlow::ConfigSig` rewrite=`False` usefulness=`semantic`
...
- `java_method_call_sink_com_mongodb_basic_dbobject_parse_3b89d47e` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`com.mongodb.BasicDBObject.parse` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_java_lang_runtime_exec_52113dc7` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`java.lang.Runtime.exec` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_c9d840b7` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_query_514e6e45` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeQuery` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_update_fea6da3c` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeUpdate` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_execute_query_execute_update_9f51233b` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute|executeQuery|executeUpdate` rewrite=`False` usefulness=`semantic`
- `java_modeled_sink_type_command_injection_sink_6ff11185` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`CommandInjectionSink` rewrite=`False` usefulness=`semantic`
...
- `java_modeled_sink_type_query_injection_sink_d3b4d4e5` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`QueryInjectionSink` rewrite=`False` usefulness=`semantic`
...
- `java_sink_kind_sink_node_command_injection_661bf632` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:command-injection` rewrite=`False` usefulness=`semantic`
- `java_sink_kind_sink_node_environment_injection_4e656c38` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:environment-injection` rewrite=`False` usefulness=`semantic`
- `java_sink_kind_sink_node_sql_injection_13d16ba6` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:sql-injection` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_remote_flow_source_d012efcf` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource` rewrite=`False` usefulness=`semantic`
- `java_source_kind_remote_flow_source_04675e95` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_source_node_database_bfe0453b` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:database` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_source_node_environment_7ab858b5` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:environment` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_source_node_remote_9df476b1` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:remote` rewrite=`False` usefulness=`semantic`
- `java_source_kind_source_node_remote_da62e92f` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:remote` rewrite=`False` usefulness=`semantic`
- `java_threat_model_active_threat_model_source_8e4eb24d` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource` rewrite=`False` usefulness=`semantic`
- `java_threat_model_active_threat_model_source_bd3900aa` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource` rewrite=`False` usefulness=`semantic`
