...
## Abstractions
Accepted rewrite helpers: 21
Accepted LILO candidates: 50
LILO-only semantic candidates: 29
Rejected for rewrite: 99
Rejected for LILO inventory: 70
Final rewritten query syntax: `True`

Rewrite helpers:
- `java_active_threat_model_source` `java_source_predicate_helper_v1`: 12 use sites, CodeQL syntax `True`
- `java_command_injection_sink_sink` `java_sink_predicate_helper_v1`: 4 use sites, CodeQL syntax `True`
- `java_simple_type_sanitizer_barrier` `java_barrier_predicate_helper_v1`: 7 use sites, CodeQL syntax `True`
- `java_remote_flow_source` `legacy_codeql_helper_v1`: 2 use sites, CodeQL syntax `True`
- `java_command_injection_sanitizer_barrier` `java_barrier_predicate_helper_v1`: 6 use sites, CodeQL syntax `True`
- `java_java_lang_runtime_exec_sink` `java_sink_predicate_helper_v1`: 2 use sites, CodeQL syntax `True`
- `java_sink_node_command_injection_sink` `java_sink_predicate_helper_v1`: 3 use sites, CodeQL syntax `True`
- `java_barrier_node_command_injection_barrier` `java_barrier_predicate_helper_v1`: 3 use sites, CodeQL syntax `True`
...
- `java_method_names_execute_query_sink` `java_sink_predicate_helper_v1`: 2 use sites, CodeQL syntax `True`
- `java_method_names_execute_update_sink` `java_sink_predicate_helper_v1`: 2 use sites, CodeQL syntax `True`
- `java_method_names_execute_sink` `java_sink_predicate_helper_v1`: 2 use sites, CodeQL syntax `True`
- `java_com_mongodb_basic_dbobject_parse_sink` `java_sink_predicate_helper_v1`: 3 use sites, CodeQL syntax `True`
- `java_query_injection_sink_sink` `java_sink_predicate_helper_v1`: 4 use sites, CodeQL syntax `True`
- `java_sink_node_sql_injection_sink` `java_sink_predicate_helper_v1`: 4 use sites, CodeQL syntax `True`
...
- `java_source_node_environment_source` `java_source_predicate_helper_v1`: 2 use sites, CodeQL syntax `True`
...
- `java_barrier_kind_command_injection_sanitizer_ba91b818` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`CommandInjectionSanitizer`
- `java_barrier_kind_exec_tainted_environment_sanitizer_426a48be` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`ExecTaintedEnvironmentSanitizer`
...
- `java_barrier_kind_simple_type_sanitizer_8da9abcb` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`SimpleTypeSanitizer`
- `java_barrier_kind_barrier_node_command_injection_fa2db844` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:command-injection`
- `java_barrier_kind_barrier_node_sql_injection_7153a40c` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:sql-injection`
- `java_method_call_sink_com_mongodb_basic_dbobject_parse_bde58390` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`com.mongodb.BasicDBObject.parse`
- `java_method_call_sink_java_lang_runtime_exec_0b577cf9` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`java.lang.Runtime.exec`
- `java_method_call_sink_method_names_execute_2b690b32` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute`
- `java_method_call_sink_method_names_execute_query_486e5c11` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeQuery`
- `java_method_call_sink_method_names_execute_update_f78d58ad` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeUpdate`
- `java_method_call_sink_method_names_execute_execute_query_execute_update_2c2619ff` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute|executeQuery|executeUpdate`
- `java_modeled_sink_type_command_injection_sink_7b36c6e8` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`CommandInjectionSink`
...
- `java_modeled_sink_type_query_injection_sink_9e8ede20` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`QueryInjectionSink`
...
- `java_sink_kind_sink_node_command_injection_5e815c34` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:command-injection`
- `java_sink_kind_sink_node_environment_injection_1a77b9fc` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:environment-injection`
- `java_sink_kind_sink_node_sql_injection_72a6c1f9` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:sql-injection`
- `java_source_kind_remote_flow_source_44d61157` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource`
- `java_source_kind_remote_flow_source_c58b87ad` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource`
- `java_source_kind_source_node_database_43415ec4` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:database`
- `java_source_kind_source_node_remote_eb073f7a` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:remote`
- `java_threat_model_active_threat_model_source_92de60e7` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource`
- `java_threat_model_active_threat_model_source_108d2db0` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource`
...
- `java_barrier_kind_command_injection_sanitizer_ba91b818`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
- `java_barrier_kind_exec_tainted_environment_sanitizer_426a48be`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
...
- `java_barrier_kind_simple_type_sanitizer_8da9abcb`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
- `java_barrier_kind_barrier_node_command_injection_fa2db844`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
- `java_barrier_kind_barrier_node_sql_injection_7153a40c`: `['unsupported kind', 'not rewrite eligible', 'helper body must be a CodeQL predicate']`
...
- `java_flow_config_template_data_flow_config_sig_6e410288`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_flow_config_template_data_flow_config_sig_49b4b8cc`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_method_call_sink_com_mongodb_basic_dbobject_parse_bde58390`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_java_lang_runtime_exec_0b577cf9`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_2b690b32`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_query_486e5c11`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_update_f78d58ad`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_method_call_sink_method_names_execute_execute_query_execute_update_2c2619ff`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_modeled_sink_type_command_injection_sink_7b36c6e8`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_modeled_sink_type_query_injection_sink_9e8ede20`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_sink_kind_sink_node_command_injection_5e815c34`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_sink_kind_sink_node_environment_injection_1a77b9fc`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_sink_kind_sink_node_sql_injection_72a6c1f9`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_remote_flow_source_44d61157`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_source_kind_remote_flow_source_c58b87ad`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_source_node_database_43415ec4`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_source_node_environment_5d7d0308`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_source_kind_source_node_remote_a9dc3ce1`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_source_kind_source_node_remote_eb073f7a`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_threat_model_active_threat_model_source_92de60e7`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
- `java_threat_model_active_threat_model_source_108d2db0`: `['unsupported kind', 'not rewrite eligible', 'unsupported rewrite schema', 'helper body must be a CodeQL predicate']`
...
- `java_flow_config_template_data_flow_config_sig_6e410288`: `['structural syntax-compression template']`
- `java_flow_config_template_data_flow_config_sig_49b4b8cc`: `['structural syntax-compression template']`
...
- `java_source_kind_android_external_storage_source_edf149a9`: `['outside bounded LILO inventory cap']`
- `java_source_kind_android_javascript_interface_method_parameter_01e51fdb`: `['outside bounded LILO inventory cap']`
- `java_source_kind_exported_android_content_provider_input_1c741880`: `['outside bounded LILO inventory cap']`
- `java_source_kind_exported_android_intent_input_5afd578a`: `['outside bounded LILO inventory cap']`
- `java_source_kind_external_remote_flow_source_c97357e4`: `['outside bounded LILO inventory cap']`
- `java_source_kind_guice_request_parameter_source_d5e556b9`: `['outside bounded LILO inventory cap']`
- `java_source_kind_jax_rs_method_parameter_source_de780bd2`: `['outside bounded LILO inventory cap']`
- `java_source_kind_jax_ws_method_parameter_source_4c05ab0a`: `['outside bounded LILO inventory cap']`
- `java_source_kind_local_user_input_66e9bccd`: `['outside bounded LILO inventory cap']`
- `java_source_kind_message_body_reader_parameter_source_810ff54e`: `['outside bounded LILO inventory cap']`
...
- `java_source_kind_source_node_environment_5d7d0308`: `['outside bounded LILO inventory cap']`
...
- `java_source_kind_source_node_remote_a9dc3ce1`: `['outside bounded LILO inventory cap']`

## Semantic Concept Mining
Extracted concepts: `294`
Mined candidates: `120`
Rewrite eligible: `22`
Semantic-only: `98`
...
- `java_sink_node_command_injection_sink` `java_sink_predicate_helper_v1` role=`Sink` target=`sinkNode:command-injection` rewrite=`True` usefulness=`semantic`
- `java_barrier_node_command_injection_barrier` `java_barrier_predicate_helper_v1` role=`Barrier` target=`barrierNode:command-injection` rewrite=`True` usefulness=`semantic`
...
- `java_method_names_execute_query_sink` `java_sink_predicate_helper_v1` role=`Sink` target=`method-names:executeQuery` rewrite=`True` usefulness=`semantic`
- `java_method_names_execute_update_sink` `java_sink_predicate_helper_v1` role=`Sink` target=`method-names:executeUpdate` rewrite=`True` usefulness=`semantic`
- `java_method_names_execute_sink` `java_sink_predicate_helper_v1` role=`Sink` target=`method-names:execute` rewrite=`True` usefulness=`semantic`
- `java_com_mongodb_basic_dbobject_parse_sink` `java_sink_predicate_helper_v1` role=`Sink` target=`com.mongodb.BasicDBObject.parse` rewrite=`True` usefulness=`semantic`
...
- `java_source_node_environment_source` `java_source_predicate_helper_v1` role=`Source` target=`sourceNode:environment` rewrite=`True` usefulness=`semantic`
...
- `java_barrier_kind_command_injection_sanitizer_ba91b818` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`CommandInjectionSanitizer` rewrite=`False` usefulness=`semantic`
- `java_barrier_kind_exec_tainted_environment_sanitizer_426a48be` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`ExecTaintedEnvironmentSanitizer` rewrite=`False` usefulness=`semantic`
...
- `java_barrier_kind_simple_type_sanitizer_8da9abcb` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`SimpleTypeSanitizer` rewrite=`False` usefulness=`semantic`
- `java_barrier_kind_barrier_node_command_injection_fa2db844` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:command-injection` rewrite=`False` usefulness=`semantic`
- `java_barrier_kind_barrier_node_sql_injection_7153a40c` `java_barrier_predicate_helper_v1` role=`BarrierKind` target=`barrierNode:sql-injection` rewrite=`False` usefulness=`semantic`
...
- `java_flow_config_template_data_flow_config_sig_6e410288` `java_flow_config_template_v1` role=`FlowConfigTemplate` target=`DataFlow::ConfigSig` rewrite=`False` usefulness=`semantic`
- `java_flow_config_template_data_flow_config_sig_49b4b8cc` `java_flow_config_template_v1` role=`FlowConfigTemplate` target=`DataFlow::ConfigSig` rewrite=`False` usefulness=`semantic`
...
- `java_method_call_sink_com_mongodb_basic_dbobject_parse_bde58390` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`com.mongodb.BasicDBObject.parse` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_java_lang_runtime_exec_0b577cf9` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`java.lang.Runtime.exec` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_2b690b32` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_query_486e5c11` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeQuery` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_update_f78d58ad` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:executeUpdate` rewrite=`False` usefulness=`semantic`
- `java_method_call_sink_method_names_execute_execute_query_execute_update_2c2619ff` `java_modeled_sink_helper_v1` role=`MethodCallSink` target=`method-names:execute|executeQuery|executeUpdate` rewrite=`False` usefulness=`semantic`
- `java_modeled_sink_type_command_injection_sink_7b36c6e8` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`CommandInjectionSink` rewrite=`False` usefulness=`semantic`
...
- `java_modeled_sink_type_query_injection_sink_9e8ede20` `java_modeled_sink_helper_v1` role=`ModeledSinkType` target=`QueryInjectionSink` rewrite=`False` usefulness=`semantic`
...
- `java_sink_kind_sink_node_command_injection_5e815c34` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:command-injection` rewrite=`False` usefulness=`semantic`
- `java_sink_kind_sink_node_environment_injection_1a77b9fc` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:environment-injection` rewrite=`False` usefulness=`semantic`
- `java_sink_kind_sink_node_sql_injection_72a6c1f9` `java_modeled_sink_helper_v1` role=`SinkKind` target=`sinkNode:sql-injection` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_remote_flow_source_44d61157` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource` rewrite=`False` usefulness=`semantic`
- `java_source_kind_remote_flow_source_c58b87ad` `java_remote_source_kind_template_v1` role=`SourceKind` target=`RemoteFlowSource` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_source_node_database_43415ec4` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:database` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_source_node_environment_5d7d0308` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:environment` rewrite=`False` usefulness=`semantic`
...
- `java_source_kind_source_node_remote_a9dc3ce1` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:remote` rewrite=`False` usefulness=`semantic`
- `java_source_kind_source_node_remote_eb073f7a` `java_remote_source_kind_template_v1` role=`SourceKind` target=`sourceNode:remote` rewrite=`False` usefulness=`semantic`
- `java_threat_model_active_threat_model_source_92de60e7` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource` rewrite=`False` usefulness=`semantic`
- `java_threat_model_active_threat_model_source_108d2db0` `java_remote_source_kind_template_v1` role=`ThreatModel` target=`ActiveThreatModelSource` rewrite=`False` usefulness=`semantic`

## Scores
- `original.json`: `{'78': {'TP': 0, 'FN': 126, 'TN': 125, 'FP': 0}, '89': {'TP': 0, 'FN': 272, 'TN': 232, 'FP': 0}}`
- `rewritten.json`: `{'78': {'TP': 0, 'FN': 126, 'TN': 125, 'FP': 0}, '89': {'TP': 0, 'FN': 272, 'TN': 232, 'FP': 0}}`
- `roundtrip.json`: `{'78': {'TP': 0, 'FN': 126, 'TN': 125, 'FP': 0}, '89': {'TP': 0, 'FN': 272, 'TN': 232, 'FP': 0}}`
