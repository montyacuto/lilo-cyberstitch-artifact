...
- `candidate:java_source_kind_remote_flow_source_get_source_type_guice_request_parameter_4fbc8cd3`: Recognizes Java CodeQL SourceKind semantics for RemoteFlowSource.getSourceType:Guice request parameter.
- `candidate:java_command_injection_sink_sink`: Recognizes Java CodeQL sink predicate semantics for CommandInjectionSink.
